            ...
            result["segments"] = [
                {
                    ...
                    "end": seg.end,
                    "text": seg.text,
                    **({"words": [w.to_dict() for w in seg.words]} if seg.words else {}),
                    **({"speaker_id": seg.speaker_id} if seg.speaker_id else {}),
                    **({"confidence_per_frame": seg.confidence_per_frame} if seg.confidence_per_frame else {}),
                }
                for seg in self.segments
            ]
